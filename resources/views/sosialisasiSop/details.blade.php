...
@section('content')
    ...
    <div class="container">
        <h3>
            <a href="/sosialisasiSop    " style="text-decoration:none; color: black;">
                < {{ str_replace('_', '/', $nra) }} </a>
        </h3>
    </div>
    ...
    <div class="container">
        <a href="/sosialisasiSop" class="btn btn-outline-secondary">Back</a>
    ...
    <script>
        ...
        const images = <?php echo json_encode($slides); ?>;
        const ttv = <?php echo json_encode($ttv); ?>;
        const combinedArray = [];
        ...
        function textToVoice(index) {
            const textToVoice = ttv[index];
            // Create a new SpeechSynthesisUtterance instance
            const utterance = new SpeechSynthesisUtterance(textToVoice);
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            changeButton.addEventListener('click', function() {
                ...
                sourceElement.src = '/storage/masterSosialisasi/' + '<?php echo $nra; ?>' + '/video/' +
                    '<?php echo $nra; ?>' + '.mp4';
